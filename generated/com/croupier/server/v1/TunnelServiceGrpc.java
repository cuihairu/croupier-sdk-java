...
public final class TunnelServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.croupier.server.v1.TunnelMessage,
      com.croupier.server.v1.TunnelMessage> getOpenMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Open",
      requestType = com.croupier.server.v1.TunnelMessage.class,
      responseType = com.croupier.server.v1.TunnelMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.croupier.server.v1.TunnelMessage,
      com.croupier.server.v1.TunnelMessage> getOpenMethod() {
    io.grpc.MethodDescriptor<com.croupier.server.v1.TunnelMessage, com.croupier.server.v1.TunnelMessage> getOpenMethod;
      ...
      synchronized (TunnelServiceGrpc.class) {
        if ((getOpenMethod = TunnelServiceGrpc.getOpenMethod) == null) {
          TunnelServiceGrpc.getOpenMethod = getOpenMethod =
              io.grpc.MethodDescriptor.<com.croupier.server.v1.TunnelMessage, com.croupier.server.v1.TunnelMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Open"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.croupier.server.v1.TunnelMessage.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<com.croupier.server.v1.TunnelMessage> open(
        io.grpc.stub.StreamObserver<com.croupier.server.v1.TunnelMessage> responseObserver) {
  ...
  public static final class TunnelServiceStub
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.croupier.server.v1.TunnelMessage> open(
        io.grpc.stub.StreamObserver<com.croupier.server.v1.TunnelMessage> responseObserver) {
  ...
  public static final class TunnelServiceBlockingV2Stub
    ...
    public io.grpc.stub.BlockingClientCall<com.croupier.server.v1.TunnelMessage, com.croupier.server.v1.TunnelMessage>
        open() {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              com.croupier.server.v1.TunnelMessage,
              com.croupier.server.v1.TunnelMessage>(
  ...
  private static abstract class TunnelServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.croupier.server.v1.TunnelProto.getDescriptor();
    }
