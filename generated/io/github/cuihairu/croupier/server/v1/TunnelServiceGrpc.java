...
public final class TunnelServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "croupier.server.v1.TunnelService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<io.github.cuihairu.croupier.server.v1.TunnelMessage,
      io.github.cuihairu.croupier.server.v1.TunnelMessage> getOpenMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Open",
      requestType = io.github.cuihairu.croupier.server.v1.TunnelMessage.class,
      responseType = io.github.cuihairu.croupier.server.v1.TunnelMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<io.github.cuihairu.croupier.server.v1.TunnelMessage,
      io.github.cuihairu.croupier.server.v1.TunnelMessage> getOpenMethod() {
    io.grpc.MethodDescriptor<io.github.cuihairu.croupier.server.v1.TunnelMessage, io.github.cuihairu.croupier.server.v1.TunnelMessage> getOpenMethod;
      ...
      synchronized (TunnelServiceGrpc.class) {
        if ((getOpenMethod = TunnelServiceGrpc.getOpenMethod) == null) {
          TunnelServiceGrpc.getOpenMethod = getOpenMethod =
              io.grpc.MethodDescriptor.<io.github.cuihairu.croupier.server.v1.TunnelMessage, io.github.cuihairu.croupier.server.v1.TunnelMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Open"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.github.cuihairu.croupier.server.v1.TunnelMessage.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<io.github.cuihairu.croupier.server.v1.TunnelMessage> open(
        io.grpc.stub.StreamObserver<io.github.cuihairu.croupier.server.v1.TunnelMessage> responseObserver) {
  ...
  public static final class TunnelServiceStub
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<io.github.cuihairu.croupier.server.v1.TunnelMessage> open(
        io.grpc.stub.StreamObserver<io.github.cuihairu.croupier.server.v1.TunnelMessage> responseObserver) {
  ...
  public static final class TunnelServiceBlockingV2Stub
    ...
    public io.grpc.stub.BlockingClientCall<io.github.cuihairu.croupier.server.v1.TunnelMessage, io.github.cuihairu.croupier.server.v1.TunnelMessage>
        open() {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              io.github.cuihairu.croupier.server.v1.TunnelMessage,
              io.github.cuihairu.croupier.server.v1.TunnelMessage>(
  ...
  private static abstract class TunnelServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.github.cuihairu.croupier.server.v1.ServerTunnel.getDescriptor();
    }
