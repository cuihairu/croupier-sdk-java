...
@javax.annotation.Generated(
    ...
    comments = "Source: examples/games/player/v1/player.proto")
...
public final class PlayerGmServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.github.cuihairu.croupier.examples.games.player.v1.BanRequest,
      io.github.cuihairu.croupier.examples.games.player.v1.BanResponse> getBanMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Ban",
      requestType = io.github.cuihairu.croupier.examples.games.player.v1.BanRequest.class,
      responseType = io.github.cuihairu.croupier.examples.games.player.v1.BanResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.github.cuihairu.croupier.examples.games.player.v1.BanRequest,
      io.github.cuihairu.croupier.examples.games.player.v1.BanResponse> getBanMethod() {
    io.grpc.MethodDescriptor<io.github.cuihairu.croupier.examples.games.player.v1.BanRequest, io.github.cuihairu.croupier.examples.games.player.v1.BanResponse> getBanMethod;
      ...
      synchronized (PlayerGmServiceGrpc.class) {
        if ((getBanMethod = PlayerGmServiceGrpc.getBanMethod) == null) {
          PlayerGmServiceGrpc.getBanMethod = getBanMethod =
              io.grpc.MethodDescriptor.<io.github.cuihairu.croupier.examples.games.player.v1.BanRequest, io.github.cuihairu.croupier.examples.games.player.v1.BanResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Ban"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.github.cuihairu.croupier.examples.games.player.v1.BanRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.github.cuihairu.croupier.examples.games.player.v1.BanResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void ban(io.github.cuihairu.croupier.examples.games.player.v1.BanRequest request,
        io.grpc.stub.StreamObserver<io.github.cuihairu.croupier.examples.games.player.v1.BanResponse> responseObserver) {
  ...
  public static final class PlayerGmServiceStub
    ...
    /**
     */
    public void ban(io.github.cuihairu.croupier.examples.games.player.v1.BanRequest request,
        io.grpc.stub.StreamObserver<io.github.cuihairu.croupier.examples.games.player.v1.BanResponse> responseObserver) {
  ...
  public static final class PlayerGmServiceBlockingStub
    ...
    /**
     */
    public io.github.cuihairu.croupier.examples.games.player.v1.BanResponse ban(io.github.cuihairu.croupier.examples.games.player.v1.BanRequest request) {
  ...
  public static final class PlayerGmServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.github.cuihairu.croupier.examples.games.player.v1.BanResponse> ban(
        io.github.cuihairu.croupier.examples.games.player.v1.BanRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_BAN:
          serviceImpl.ban((io.github.cuihairu.croupier.examples.games.player.v1.BanRequest) request,
              (io.grpc.stub.StreamObserver<io.github.cuihairu.croupier.examples.games.player.v1.BanResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              io.github.cuihairu.croupier.examples.games.player.v1.BanRequest,
              io.github.cuihairu.croupier.examples.games.player.v1.BanResponse>(
  ...
  private static abstract class PlayerGmServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.github.cuihairu.croupier.examples.games.player.v1.Player.getDescriptor();
    }
