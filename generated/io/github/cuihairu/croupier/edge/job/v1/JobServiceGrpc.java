...
public final class JobServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.github.cuihairu.croupier.edge.job.v1.GetJobResultRequest,
      io.github.cuihairu.croupier.edge.job.v1.GetJobResultResponse> getGetJobResultMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetJobResult",
      requestType = io.github.cuihairu.croupier.edge.job.v1.GetJobResultRequest.class,
      responseType = io.github.cuihairu.croupier.edge.job.v1.GetJobResultResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.github.cuihairu.croupier.edge.job.v1.GetJobResultRequest,
      io.github.cuihairu.croupier.edge.job.v1.GetJobResultResponse> getGetJobResultMethod() {
    io.grpc.MethodDescriptor<io.github.cuihairu.croupier.edge.job.v1.GetJobResultRequest, io.github.cuihairu.croupier.edge.job.v1.GetJobResultResponse> getGetJobResultMethod;
      ...
      synchronized (JobServiceGrpc.class) {
        if ((getGetJobResultMethod = JobServiceGrpc.getGetJobResultMethod) == null) {
          JobServiceGrpc.getGetJobResultMethod = getGetJobResultMethod =
              io.grpc.MethodDescriptor.<io.github.cuihairu.croupier.edge.job.v1.GetJobResultRequest, io.github.cuihairu.croupier.edge.job.v1.GetJobResultResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetJobResult"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.github.cuihairu.croupier.edge.job.v1.GetJobResultRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.github.cuihairu.croupier.edge.job.v1.GetJobResultResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getJobResult(io.github.cuihairu.croupier.edge.job.v1.GetJobResultRequest request,
        io.grpc.stub.StreamObserver<io.github.cuihairu.croupier.edge.job.v1.GetJobResultResponse> responseObserver) {
  ...
  public static final class JobServiceStub
    ...
    /**
     */
    public void getJobResult(io.github.cuihairu.croupier.edge.job.v1.GetJobResultRequest request,
        io.grpc.stub.StreamObserver<io.github.cuihairu.croupier.edge.job.v1.GetJobResultResponse> responseObserver) {
  ...
  public static final class JobServiceBlockingStub
    ...
    /**
     */
    public io.github.cuihairu.croupier.edge.job.v1.GetJobResultResponse getJobResult(io.github.cuihairu.croupier.edge.job.v1.GetJobResultRequest request) {
  ...
  public static final class JobServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.github.cuihairu.croupier.edge.job.v1.GetJobResultResponse> getJobResult(
        io.github.cuihairu.croupier.edge.job.v1.GetJobResultRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_JOB_RESULT:
          serviceImpl.getJobResult((io.github.cuihairu.croupier.edge.job.v1.GetJobResultRequest) request,
              (io.grpc.stub.StreamObserver<io.github.cuihairu.croupier.edge.job.v1.GetJobResultResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              io.github.cuihairu.croupier.edge.job.v1.GetJobResultRequest,
              io.github.cuihairu.croupier.edge.job.v1.GetJobResultResponse>(
  ...
  private static abstract class JobServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.github.cuihairu.croupier.edge.job.v1.Job.getDescriptor();
    }
