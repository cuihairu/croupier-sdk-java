...
public final class ManagementServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.github.cuihairu.croupier.api.v1.ManagementRequest,
      io.github.cuihairu.croupier.api.v1.ManagementResponse> getManageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Manage",
      requestType = io.github.cuihairu.croupier.api.v1.ManagementRequest.class,
      responseType = io.github.cuihairu.croupier.api.v1.ManagementResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.github.cuihairu.croupier.api.v1.ManagementRequest,
      io.github.cuihairu.croupier.api.v1.ManagementResponse> getManageMethod() {
    io.grpc.MethodDescriptor<io.github.cuihairu.croupier.api.v1.ManagementRequest, io.github.cuihairu.croupier.api.v1.ManagementResponse> getManageMethod;
      ...
      synchronized (ManagementServiceGrpc.class) {
        if ((getManageMethod = ManagementServiceGrpc.getManageMethod) == null) {
          ManagementServiceGrpc.getManageMethod = getManageMethod =
              io.grpc.MethodDescriptor.<io.github.cuihairu.croupier.api.v1.ManagementRequest, io.github.cuihairu.croupier.api.v1.ManagementResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Manage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.github.cuihairu.croupier.api.v1.ManagementRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.github.cuihairu.croupier.api.v1.ManagementResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void manage(io.github.cuihairu.croupier.api.v1.ManagementRequest request,
        io.grpc.stub.StreamObserver<io.github.cuihairu.croupier.api.v1.ManagementResponse> responseObserver) {
  ...
  public static final class ManagementServiceStub
     ...
     * </pre>
     */
    public void manage(io.github.cuihairu.croupier.api.v1.ManagementRequest request,
        io.grpc.stub.StreamObserver<io.github.cuihairu.croupier.api.v1.ManagementResponse> responseObserver) {
  ...
  public static final class ManagementServiceBlockingStub
     ...
     * </pre>
     */
    public io.github.cuihairu.croupier.api.v1.ManagementResponse manage(io.github.cuihairu.croupier.api.v1.ManagementRequest request) {
  ...
  public static final class ManagementServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<io.github.cuihairu.croupier.api.v1.ManagementResponse> manage(
        io.github.cuihairu.croupier.api.v1.ManagementRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MANAGE:
          serviceImpl.manage((io.github.cuihairu.croupier.api.v1.ManagementRequest) request,
              (io.grpc.stub.StreamObserver<io.github.cuihairu.croupier.api.v1.ManagementResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              io.github.cuihairu.croupier.api.v1.ManagementRequest,
              io.github.cuihairu.croupier.api.v1.ManagementResponse>(
  ...
  private static abstract class ManagementServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.github.cuihairu.croupier.api.v1.Management.getDescriptor();
    }
