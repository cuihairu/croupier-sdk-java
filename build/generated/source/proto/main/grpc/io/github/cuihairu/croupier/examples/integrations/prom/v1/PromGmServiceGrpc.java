...
@javax.annotation.Generated(
    ...
    comments = "Source: examples/integrations/prom/v1/prom.proto")
...
public final class PromGmServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeRequest,
      io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeResponse> getQueryRangeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "QueryRange",
      requestType = io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeRequest.class,
      responseType = io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeRequest,
      io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeResponse> getQueryRangeMethod() {
    io.grpc.MethodDescriptor<io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeRequest, io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeResponse> getQueryRangeMethod;
      ...
      synchronized (PromGmServiceGrpc.class) {
        if ((getQueryRangeMethod = PromGmServiceGrpc.getQueryRangeMethod) == null) {
          PromGmServiceGrpc.getQueryRangeMethod = getQueryRangeMethod =
              io.grpc.MethodDescriptor.<io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeRequest, io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "QueryRange"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void queryRange(io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeRequest request,
        io.grpc.stub.StreamObserver<io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeResponse> responseObserver) {
  ...
  public static final class PromGmServiceStub
    ...
    /**
     */
    public void queryRange(io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeRequest request,
        io.grpc.stub.StreamObserver<io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeResponse> responseObserver) {
  ...
  public static final class PromGmServiceBlockingStub
    ...
    /**
     */
    public io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeResponse queryRange(io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeRequest request) {
  ...
  public static final class PromGmServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeResponse> queryRange(
        io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_QUERY_RANGE:
          serviceImpl.queryRange((io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeRequest) request,
              (io.grpc.stub.StreamObserver<io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeRequest,
              io.github.cuihairu.croupier.examples.integrations.prom.v1.QueryRangeResponse>(
  ...
  private static abstract class PromGmServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.github.cuihairu.croupier.examples.integrations.prom.v1.Prom.getDescriptor();
    }
